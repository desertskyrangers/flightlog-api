...
public interface AircraftRepo extends PagingAndSortingRepository<AircraftEntity, UUID> {
	...
	Page<AircraftEntity> findAircraftByOwnerOrderByName( UUID owner, Pageable pageable );
